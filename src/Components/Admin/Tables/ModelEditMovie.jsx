  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        let poster1 = movie.poster1
        let poster2 = movie.poster2
        let poster3 = movie.poster2
        ...
        if (image1) {
          var imageRef = storage.refFromURL(poster1);
          imageRef.delete()
        ...
        if (image2) {
          var imageRef = storage.refFromURL(poster2);
          imageRef.delete()
        ...
        if (image3) {
          var imageRef = storage.refFromURL(poster3);
          imageRef.delete()
